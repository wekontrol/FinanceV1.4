    ...
    <div className="space-y-6 md:space-y-8 animate-fade-in w-full max-w-full overflow-x-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" data-tour="dashboard-cards">
          {/* Saldo */}
          <div className="bg-gradient-to-br from-indigo-600 to-violet-700 rounded-3xl p-6 text-white shadow-lg shadow-indigo-500/20 relative overflow-hidden min-w-0 transition-transform hover:scale-[1.02] duration-300">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-3xl p-6 shadow-soft border border-slate-100 dark:border-slate-700 flex flex-col items-center justify-between relative overflow-hidden min-h-[240px]">
            ...
            <div className="h-40 w-full relative flex items-center justify-center">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 text-center mt-4">
                 <span className={`text-2xl md:text-4xl font-extrabold ${healthScore > 70 ? 'text-emerald-500' : healthScore > 40 ? 'text-amber-500' : 'text-rose-500'}`}>
                   {healthScore}
                 </span>
            ...
            <div className="text-center z-10 mt-2">
               <p className={`text-xs md:text-sm font-bold py-1 px-3 rounded-full bg-slate-50 dark:bg-slate-700/50 ${healthScore > 70 ? 'text-emerald-600 dark:text-emerald-400' : healthScore > 40 ? 'text-amber-600 dark:text-amber-400' : 'text-rose-600 dark:text-rose-400'}`}>
